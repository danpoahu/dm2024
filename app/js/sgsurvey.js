import { db, doc, updateDoc } from './firebase-config.js?v=39';
import { navigate, userData, setUserData, currentSession, pendingDISC, setPendingDISC } from './app.js?v=39';
import { SG_QUESTIONS } from './data.js?v=39';
