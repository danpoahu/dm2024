import { db, doc, updateDoc } from './firebase-config.js?v=34';
import { navigate, userData, setUserData, currentSession, pendingDISC, setPendingDISC } from './app.js?v=34';
import { SG_QUESTIONS } from './data.js?v=34';
