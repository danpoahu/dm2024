import { db, doc, getDoc } from './firebase-config.js?v=38';
import { navigate, setUserData, userData, currentSession, setCurrentSession } from './app.js?v=38';
import { SPIRITUAL_GIFTS } from './data.js?v=38';
