import { db, doc, getDoc } from './firebase-config.js?v=39';
import { navigate, setUserData, userData, currentSession, setCurrentSession } from './app.js?v=39';
import { SPIRITUAL_GIFTS } from './data.js?v=39';
